...
def _clear_druggability_default(apps, schema_editor):
    ScoreFormula = apps.get_model("tpweb", "ScoreFormula")
    ScoreFormula.objects.filter(name="Druggability").update(default=False)
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(_clear_druggability_default, migrations.RunPython.noop),
    ]
