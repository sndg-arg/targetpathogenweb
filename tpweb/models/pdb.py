...
class Residue(models.Model):
    ...
    pdb = models.ForeignKey(
        PDB, related_name="residues", db_column="pdb_id", on_delete=models.CASCADE
    )
...
class Atom(models.Model):
    ...
    residue = models.ForeignKey(
        Residue, related_name="atoms", db_column="residue_id", on_delete=models.CASCADE
    )
    x = models.FloatField()
    y = models.FloatField()
    z = models.FloatField()
    ...
    def line(self, r):
        ...
        line += str(self.serial).rjust(
            5
        )  # 7 - 11        Integer       serial       Atom  serial number.
        if r.resname == "STP":
            line += " "
            line += self.name.strip().ljust(
                4
        ...
        line += str(r.resid).rjust(
            4
        )  # 23 - 26        Integer       resSeq       Residue sequence number.
        line += r.icode.rjust(
            4
        )  # 27             AChar         iCode        Code for insertion of residues.
        line += f"{self.x:.3f}".rjust(
            8
        )  # 31 - 38        Real(8.3)     x            Orthogonal coordinates for X in Angstroms.
        line += f"{self.y:.3f}".rjust(
            8
        )  # 39 - 46        Real(8.3)     y            Orthogonal coordinates for Y in Angstroms.
        line += f"{self.z:.3f}".rjust(
            8
        )  # 47 - 54        Real(8.3)     z            Orthogonal coordinates for Z in Angstroms.
        line += f"{self.occupancy:.2f}".rjust(
            6
        )  # 55 - 60        Real(6.2)     occupancy    Occupancy.
        line += f"{self.bfactor:.2f}".rjust(
            6
        )  # 61 - 66        Real(6.2)     tempFactor   Temperature  factor.
        line += "".rjust(10)
        line += self.element.rjust(
            2
...
class PDBResidueSet(models.Model):
    id = models.AutoField(primary_key=True)
    pdb = models.ForeignKey(
        PDB, related_name="residue_sets", db_column="pdb_id", on_delete=models.CASCADE
    )
    residue_set = models.ForeignKey(
        ResidueSet, related_name="residuesets", db_column="residueset_id", on_delete=models.CASCADE
    )
...
class ResidueSetResidue(models.Model):
    id = models.AutoField(primary_key=True)
    residue = models.ForeignKey(
        Residue, related_name="residue_sets", db_column="residue_id", on_delete=models.CASCADE
    )
    pdbresidue_set = models.ForeignKey(
        PDBResidueSet,
        related_name="residue_set_residue",
        db_column="pdbresidueset_id",
...
class AtomResidueSet(models.Model):
    ...
    pdb_set = models.ForeignKey(
        ResidueSetResidue,
        related_name="atoms",
        db_column="residuesetresidue_id",
        on_delete=models.CASCADE,
    )
...
class PropertyTag(models.Model):
    ...
    property = models.ForeignKey(
        Property, related_name="tags", db_column="residue_id", on_delete=models.DO_NOTHING
    )
...
class PDBProperty(models.Model):
    id = models.AutoField(primary_key=True)
    pdb = models.ForeignKey(
        PDB, related_name="properties", db_column="pdb_id", on_delete=models.CASCADE
    )
...
class ResidueProperty(models.Model):
    id = models.AutoField(primary_key=True)
    residue = models.ForeignKey(
        Residue, related_name="properties", db_column="residue_id", on_delete=models.CASCADE
    )
    property = models.ForeignKey(PDB, db_column="property_id", on_delete=models.DO_NOTHING)
    value = models.FloatField(null=True)
    tag = models.ForeignKey(
...
class ResidueSetProperty(models.Model):
    ...
    property = models.ForeignKey(
        Property, related_name="residuesets", db_column="property_id", on_delete=models.DO_NOTHING
    )
    value = models.FloatField(null=True)
    tag = models.ForeignKey(
        PropertyTag,
        related_name="residue_sets",
        db_column="propertytag_id",
        null=True,
        on_delete=models.DO_NOTHING,
    )
...
class ChainProperty(models.Model):
    id = models.AutoField(primary_key=True)
    pdb = models.ForeignKey(
        PDB, related_name="chain_props", db_column="pdb_id", on_delete=models.CASCADE
    )
    chain = models.CharField(max_length=10)
    property = models.ForeignKey(
        Property, related_name="chains", db_column="property_id", on_delete=models.DO_NOTHING
    )
    value = models.FloatField(null=True)
    tag = models.ForeignKey(
        PropertyTag,
...
class AtomProperty(models.Model):
    ...
    atom = models.ForeignKey(
        Atom, related_name="properties", db_column="atom_id", on_delete=models.CASCADE
    )
    property = models.ForeignKey(
        Property, db_column="property_id", on_delete=models.DO_NOTHING, related_name="atoms"
    )
    value = models.FloatField(null=True)
    tag = models.ForeignKey(
        PropertyTag,
