...
class ActivityDashboardBlockedIpsListTests(TestCase):
    """Read-only -- blocking is fully automatic (BlockedIPMiddleware) and
    unblocking happens in the Django admin, not through this view."""
