...
MIDDLEWARE = [
    ...
    "tpweb.middleware.access_control.BlockedIPMiddleware",
...
# Production security defaults. These remain configurable because TLS is usually
# terminated by Traefik in cluster deployments.
