...
urlpatterns = [
    ...
    path("accounts/password/reset/done/", _password_reset_disabled, name="account_reset_password_done"),
    re_path(
        r"^accounts/password/reset/key/(?P<uidb36>[0-9A-Za-z]+)-(?P<key>.+)/$",
        _password_reset_disabled,
        name="account_reset_password_from_key",
    ),
    path("accounts/password/reset/key/done/", _password_reset_disabled, name="account_reset_password_from_key_done"),
